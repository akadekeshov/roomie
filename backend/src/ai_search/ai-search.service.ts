      ...
      return {
        results: scored.map((item) => ({
          user: {
            ...
            searchDistrict: item.recommendation.searchDistrict ?? null,
            occupationStatus: item.recommendation.occupationStatus ?? null,
            searchBudgetMin: item.recommendation.searchBudgetMin ?? null,
            searchBudgetMax: item.recommendation.searchBudgetMax ?? null,
